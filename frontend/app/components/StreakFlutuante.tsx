    ...
    return (
        <>
            <button
                ...
                aria-label={jaLeuHoje ? `Sequência de ${streak} dias de leitura` : "Registrar leitura de hoje"}
                className={cn(
                    ...
                    jaLeuHoje ? "cursor-default py-1.5 pl-3 pr-3" : "py-1.5 pl-3 pr-1.5 active:scale-95",
                )}
            >
                <span
                    className={cn(
                ...
                <span className={cn("text-base leading-none", streak === 0 && !carregando && "grayscale")}>🔥</span>
                {!jaLeuHoje && (
