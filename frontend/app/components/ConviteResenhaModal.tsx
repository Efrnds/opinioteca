...
export default function ConviteResenhaModal({ open, livro, onAceitar, onDispensar }: ConviteResenhaModalProps) {
    if (!livro) {
        return null;
    }
            ...
            <DialogContent className="max-w-sm rounded-3xl sm:rounded-4xl">
                ...
                <div className="flex flex-col items-center gap-3 py-2 text-center">
                    ...
                    <p className="font-gabarito-bold text-base text-azul-900">
                        Quer fazer a resenha deste livro?
                    </p>
                </div>
